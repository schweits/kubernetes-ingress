...
- For NGINX Plus, use the 1.12.1 image from the F5 Container Registry - see [the documentation here]({{< relref "installation/nic-images/pulling-ingress-controller-image" >}})
...
- [1241](https://github.com/nginxinc/kubernetes-ingress/pull/1241) improved the Makefile. As a result, the commands for building the Ingress Controller image were changed. See the updated commands [here]({{< relref "installation/building-nginx-ingress-controller#build-image-push-to-private-repo" >}}).
